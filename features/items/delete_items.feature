...
When I send a DELETE request to "/items/[id].json" with Id "ItemId"
...
@crud
Scenario: Delete an existing item by Id of the Project
Given I have set a connection to application
  And I have basic authentication
...
Given I have set a connection to application
  And I have basic authentication
  When I send a DELETE request to "/items/[id].json" with Id "default"
Then I expect HTTP code 200
